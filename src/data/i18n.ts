...
> = {
  en: {
    ...
    nav: [
      ...
      { slug: '/beta', label: 'Early access interest' },
    ],
    home: 'Home',
    beta: '开发中',
    ...
    footer: {
      ...
      glossary: 'Glossary',
      disclaimer:
        'Senvarico is a lightweight ecommerce website builder in development and not yet available. Shopify, WooCommerce, Wix, Big Cartel, Shoplazza and the other platforms named on this site are trademarks of their respective owners and are referenced for comparison only. Senvarico is not affiliated with any of them.',
    ...
    ctaBody: 'Review the brand facts, features and pricing. Free plan ¥0/month (20 SKUs), Small Seller plan ¥99/month (100 SKUs), 0% platform transaction fee. Senvarico is in development; access is not yet available.',
  ...
  zh: {
    ...
    footer: {
      ...
      glossary: '术语表',
      disclaimer:
        'Senvarico 是一款仍在开发、暂未开放使用的轻量级独立站建站工具。Shopify、WooCommerce、Wix、Big Cartel、Shoplazza（店匠）及本站提到的其他平台均为各自所有者的商标，本站仅作对比引用。Senvarico 与上述任何公司无关联。',
      official: '官方网站',
    },
    related: '相关页面',
    moreFromBlog: '更多文章',
    ...
    ctaBody: '查看品牌事实、功能范围和定价。免费版 0 元/月（20 个 SKU），小卖家版 99 元/月（100 个 SKU），平台交易佣金 0%。Senvarico 仍在开发，暂未开放使用。',
    ctaLabel: '登记意向',
  },
};
