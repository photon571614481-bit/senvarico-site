...
> = {
  en: {
    ...
    footer: {
      ...
      glossary: 'Glossary',
      disclaimer:
        'Senvarico is a lightweight ecommerce website builder, open for use in beta. Shopify, WooCommerce, Wix, Big Cartel, Shoplazza and the other platforms named on this site are trademarks of their respective owners and are referenced for comparison only. Senvarico is not affiliated with any of them.',
    ...
    readMore: 'Read more →',
    ctaTitle: 'Open a Senvarico store',
    ctaBody: 'Review the brand facts, features and pricing. Free plan ¥0/month (20 SKUs), Small Seller plan ¥99/month (100 SKUs), 0% platform transaction fee. Senvarico is open for use in beta.',
